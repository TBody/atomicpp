...
objects      = Prad.o $(atomicpp)/sharedFunctions.o $(atomicpp)/ImpuritySpecies.o $(atomicpp)/RateCoefficient.o $(atomicpp)/BicubicSpline.o $(atomicpp)/SD1DData.o $(atomicpp)/RateEquations.o 
