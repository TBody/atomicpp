...
# distutils: sources = [ImpuritySpecies.cpp, RateCoefficient.cpp, sharedFunctions.cpp, RateEquations.cpp, BilinearSpline.cpp, BicubicSpline.cpp, BivariateBSpline.cpp]
