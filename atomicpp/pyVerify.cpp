...
static PyObject* __pyx_convert__to_py_struct__atomicpp_3a__3a_DerivStruct(struct atomicpp::DerivStruct s);
/* CIntFromPy.proto */
...
static int __pyx_pw_8atomicpp_8pyVerify_17PyImpuritySpecies_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_impurity_symbol_supplied,0};
    PyObject* values[1] = {0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_impurity_symbol_supplied)) != 0)) kw_args--;
    ...
    __pyx_v_impurity_symbol_supplied = __pyx_convert_string_from_py_std__in_string(values[0]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L3_error)
  }
 ...
 */
  try {
    __pyx_t_1 = new atomicpp::ImpuritySpecies(__pyx_v_impurity_symbol_supplied);
  } catch(...) {
    __Pyx_CppExn2PyErr();
...
static int __pyx_pw_8atomicpp_8pyVerify_15PyRateEquations_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_impurity,0};
    PyObject* values[1] = {0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_impurity)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
      }
      if (unlikely(kw_args > 0)) {
 ...
 */
  try {
    __pyx_t_1 = new atomicpp::RateEquations((__pyx_v_impurity->ImpuritySpeciesPtr[0]));
  } catch(...) {
    __Pyx_CppExn2PyErr();
...
static PyObject *__pyx_pw_8atomicpp_8pyVerify_15PyRateEquations_5setThresholdDensity(PyObject *__pyx_v_self, PyObject *__pyx_arg_density_threshold) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("setThresholdDensity (wrapper)", 0);
  assert(__pyx_arg_density_threshold); {
    __pyx_v_density_threshold = __pyx_PyFloat_AsDouble(__pyx_arg_density_threshold); if (unlikely((__pyx_v_density_threshold == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 50, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
...
static PyObject *__pyx_pw_8atomicpp_8pyVerify_15PyRateEquations_7setDominantIonMass(PyObject *__pyx_v_self, PyObject *__pyx_arg_mi_in_amu) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("setDominantIonMass (wrapper)", 0);
  assert(__pyx_arg_mi_in_amu); {
    __pyx_v_mi_in_amu = __pyx_PyFloat_AsDouble(__pyx_arg_mi_in_amu); if (unlikely((__pyx_v_mi_in_amu == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 52, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
...
static PyObject *__pyx_pw_8atomicpp_8pyVerify_15PyRateEquations_9computeDerivs(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  double __pyx_v_Nn;
  double __pyx_v_Vn;
  std::vector<double>  __pyx_v_Nzk;
  std::vector<double>  __pyx_v_Vzk;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("computeDerivs (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_Te,&__pyx_n_s_Ne,&__pyx_n_s_Vi,&__pyx_n_s_Nn,&__pyx_n_s_Vn,&__pyx_n_s_Nzk,&__pyx_n_s_Vzk,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Ne)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("computeDerivs", 1, 7, 7, 1); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Vi)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("computeDerivs", 1, 7, 7, 2); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Nn)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("computeDerivs", 1, 7, 7, 3); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Vn)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("computeDerivs", 1, 7, 7, 4); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Nzk)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("computeDerivs", 1, 7, 7, 5); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Vzk)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("computeDerivs", 1, 7, 7, 6); __PYX_ERR(0, 54, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "computeDerivs") < 0)) __PYX_ERR(0, 54, __pyx_L3_error)
      }
    ...
    __pyx_v_Te = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_Te == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_Ne = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_Ne == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_Vi = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_Vi == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_Nn = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_Nn == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_Vn = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_Vn == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_Nzk = __pyx_convert_vector_from_py_double(values[5]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_Vzk = __pyx_convert_vector_from_py_double(values[6]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 54, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
 ...
 */
  ...
  __pyx_t_1 = __pyx_convert__to_py_struct__atomicpp_3a__3a_DerivStruct(__pyx_v_self->RateEquationsPtr->computeDerivs(__pyx_v_Te, __pyx_v_Ne, __pyx_v_Vi, __pyx_v_Nn, __pyx_v_Vn, __pyx_v_Nzk, __pyx_v_Vzk)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 55, __pyx_L1_error)
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_F_zk, __pyx_k_F_zk, sizeof(__pyx_k_F_zk), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_Pcool, __pyx_k_Pcool, sizeof(__pyx_k_Pcool), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_Vzk, __pyx_k_Vzk, sizeof(__pyx_k_Vzk), 0, 0, 1, 1},
  {&__pyx_n_s_dNe, __pyx_k_dNe, sizeof(__pyx_k_dNe), 0, 0, 1, 1},
  {&__pyx_n_s_dNn, __pyx_k_dNn, sizeof(__pyx_k_dNn), 0, 0, 1, 1},
  {&__pyx_n_s_dNzk, __pyx_k_dNzk, sizeof(__pyx_k_dNzk), 0, 0, 1, 1},
  {&__pyx_n_s_impurity, __pyx_k_impurity, sizeof(__pyx_k_impurity), 0, 0, 1, 1},
  {&__pyx_n_s_impurity_symbol_supplied, __pyx_k_impurity_symbol_supplied, sizeof(__pyx_k_impurity_symbol_supplied), 0, 0, 1, 1},
...
static PyObject* __pyx_convert__to_py_struct__atomicpp_3a__3a_DerivStruct(struct atomicpp::DerivStruct s) {
  ...
  member = PyFloat_FromDouble(s.Pcool); if (unlikely(!member)) goto bad;
  if (unlikely(PyDict_SetItem(res, __pyx_n_s_Pcool, member) < 0)) goto bad;
  Py_DECREF(member);
  member = PyFloat_FromDouble(s.Prad); if (unlikely(!member)) goto bad;
  if (unlikely(PyDict_SetItem(res, __pyx_n_s_Prad, member) < 0)) goto bad;
  Py_DECREF(member);
  member = __pyx_convert_vector_to_py_double(s.dNzk); if (unlikely(!member)) goto bad;
  if (unlikely(PyDict_SetItem(res, __pyx_n_s_dNzk, member) < 0)) goto bad;
  Py_DECREF(member);
  member = __pyx_convert_vector_to_py_double(s.F_zk); if (unlikely(!member)) goto bad;
  if (unlikely(PyDict_SetItem(res, __pyx_n_s_F_zk, member) < 0)) goto bad;
  Py_DECREF(member);
  member = PyFloat_FromDouble(s.dNe); if (unlikely(!member)) goto bad;
  if (unlikely(PyDict_SetItem(res, __pyx_n_s_dNe, member) < 0)) goto bad;
  Py_DECREF(member);
  member = PyFloat_FromDouble(s.F_i); if (unlikely(!member)) goto bad;
  if (unlikely(PyDict_SetItem(res, __pyx_n_s_F_i, member) < 0)) goto bad;
  Py_DECREF(member);
  member = PyFloat_FromDouble(s.dNn); if (unlikely(!member)) goto bad;
  if (unlikely(PyDict_SetItem(res, __pyx_n_s_dNn, member) < 0)) goto bad;
  Py_DECREF(member);
  member = PyFloat_FromDouble(s.F_n); if (unlikely(!member)) goto bad;
  if (unlikely(PyDict_SetItem(res, __pyx_n_s_F_n, member) < 0)) goto bad;
  Py_DECREF(member);
  return res;
  bad:
  Py_XDECREF(member);
